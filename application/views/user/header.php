    ...
    <header class="sticky-top shadow border-bottom navbar-color">
        ...
        <nav class="navbar container-xl">
            <div class="nav nav-fill container-fluid">
                ...
                ?>
                    <!-- When not logged in -->
                    <a class="btn btn-light rounded-0 mx-1" href="<?php echo base_url('main/login'); ?>">LOGIN</a>
                    <a class="btn btn-outline-light rounded-0" href="<?php echo base_url('main/signup'); ?>">SIGN UP</a>
                <?php } ?>
                </div>
            </div>
        </nav>
